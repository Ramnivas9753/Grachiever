            ...
            <form action="#" className="space-y-8 mt-20">
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                    <div className="w-full">
                        <label for="subject" className="block mb-2 font-bold text-[#0A0878] text-lg">Name</label>
                    ...
                    <div className="w-full">
                        <label for="email" className="block mb-2 font-bold text-[#0A0878] text-lg">Your email</label>
                ...
                <div className="sm:col-span-2">
                    <label for="message" className="block mb-2 font-bold text-[#0A0878] text-lg">Message</label>
