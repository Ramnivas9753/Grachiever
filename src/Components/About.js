...
<section>
  <div className="bg-[#1b1d38] p-5 text-center sm:text-2xl md:text-3xl lg:text-5xl text-white rounded-3xl ">
...
<div className="bg-[#00C5FF] absolute top-7 left-60 sm:text-2xl md:text-3xl text-xs rounded-tl-3xl rounded-br-3xl p-3 font-bold text-center  shadow-[0_10px_10px_-5px_rgba(0,0,0,0.5)] w-max ">
    <h2>Online Courses</h2>
</div>
<br></br>
<div className="bg-[#F6D93D] absolute top-32 right-20 sm:text-2xl md:text-3xl text-xs rounded-tl-3xl rounded-br-3xl p-3 font-bold text-center  shadow-[0_10px_10px_-5px_rgba(0,0,0,0.5)]  w-max">
...
<div className="bg-[#F6D93D] absolute bottom-20 left-20 sm:text-2xl md:text-3xl text-xs rounded-tr-3xl rounded-bl-3xl p-3 font-bold text-center  shadow-[0_10px_10px_-5px_rgba(0,0,0,0.5)]  w-max">
    <h1>Tools & Resources</h1>
</div>
<div className="bg-[#F6D93D] absolute bottom-60 left-30  sm:text-2xl md:text-3xl text-xs rounded-tr-3xl rounded-bl-3xl p-3 font-bold text-center  shadow-[0_10px_10px_-5px_rgba(0,0,0,0.5)]  w-max">
...
<section>
  <div className=" relative bg-[#1b1d38] p-40  text-center sm:text-2xl md:text-3xl lg:text-5xl  text-white rounded-3xl">
