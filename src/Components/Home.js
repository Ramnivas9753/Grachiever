    ...
    <section className="p-0 sm:p-0 md:p-10 lg:p-10 mt-5">
      <div className="h-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
        <div className="lg:h-full md:h-full mx-5 sm:mx-5 md:mx-10 lg:mx-10">
            ...
            <div className=' mt-10'>
       <button className="bg-[#00c5ff] hover:bg-white text-white hover:text-black border-2 border-[#00c5ff] p-2 rounded-xl   px-8 text-lg  font-bold"><Link to="/Skillgraph.js">Learn More</Link></button>
       </div>
        </div>
    {/* <!--Graph Section--> */}
