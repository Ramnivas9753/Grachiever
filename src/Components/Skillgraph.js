...
function Skill() {
    return (
                    ...
                    <div className="lg:h-full md:h-full mt-20  mx-5 sm:mx-5 md:mx-10 lg:mx-10">
                     <h1 className="text-3xl  font-bold  p-0 mr-0 ">Navigating the <span class="text-[#00c5ff]">Professional Skills</span> Landscape </h1>
                        ...
                        <div className='grid mt-10'>
                           <button className="bg-[#00c5ff] hover:bg-white text-white hover:text-black border-2 border-[#00c5ff] p-2 rounded-xl mx-auto px-8 text-lg font-bold justify-self-center"
                           data-aos="zoom-in"
                           data-aos-easing="ease-out-cubic"
      ...
      <div className=" m-2 mx-5 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 mt-0">
        ...
        <div className="mb-5">
            <button className="p-2 rounded-lg bg-[#349fcf] hover:bg-white text-white hover:text-black border-2 border-[#349fcf] px-8 text-lg "
            data-aos="zoom-in"
            data-aos-easing="ease-out-cubic"
