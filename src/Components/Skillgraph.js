...
function Skill() {
    return (
        <>
            {/* <!--Skill Section--> */}
            <section className="p-0 sm:p-0 md:p-x-10 lg:p-x-10 mt-20"
              data-aos="fade-up"
              ...
              data-aos-duration="2000">
                ...
                <div className="h-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
                    ...
                    <div className="lg:h-full md:h-full mx-5 sm:mx-5 md:mx-10 lg:mx-10 mt-10">
                        <p className="mt-7 mr-25 text-sm sm:text-lg">
            ...
            <section className="p-0 sm:p-0 md:p-x-5 lg:p-x-5 mt-1"
              data-aos="fade-up"
              data-aos-easing="ease-out-cubic"
              data-aos-duration="2000">
                <div className="h-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
                    <div className="lg:h-full md:h-full mx-5 sm:mx-5 md:mx-10 lg:mx-10 mt-20">
                        <h1 className="text-3xl font-bold text-left p-3 mt-2">Understanding <span className="text-[#00c5ff]">Skill Graph</span> </h1>
            ...
            <section className="p-0 sm:p-0 md:p-x-10 lg:p-x-10 mt-5"
              data-aos="fade-up"
              data-aos-easing="ease-out-cubic"
              data-aos-duration="2000">
                <div className="h-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
            ...
            <section className="p-0 sm:p-0 md:p-x-10 lg:p-x-10 mt-0"
              data-aos="fade-up"
              data-aos-easing="ease-out-cubic"
              data-aos-duration="2000">
                <div className="h-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
                    <div className="lg:h-full md:h-full mx-5 sm:mx-5 md:mx-10 lg:mx-10 mt-20">
                        <h1 className="text-3xl font-bold text-left p-3 mt-2">Tailored Skill <span className="text-[#00c5ff]">Development</span> Plan </h1>
                        <p className="mt-5 text-sm sm:text-lg">
