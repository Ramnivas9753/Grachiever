      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2" >
        ...
        <div className=" bg-white rounded-md items-center mb-20 md:mt-20 p-2 w-full md:w-96">
          ...
          {!isLogin && (
            ...
            <button type="submit" className="bg-[#00c5ff] hover:text-black border-2 border-[#00c5ff] hover:bg-white text-white rounded-md w-full md:w-96 px-4 py-2">RESET PASSWORD</button>
