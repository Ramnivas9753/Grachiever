            ...
            <section className="p-0 sm:p-0 md:p-0 lg:p-0 mt-12 md:mt-28 mx-5"
                ...
                <div className=" grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2" >
                    <div className="mt-20 md:w-[100%] bg-[#1b1d38] rounded-3xl">
                        <h1 className="text-3xl md:text-6xl font-bold text-white text-left md:px-24 p-12 mt-8">Tailored Skill <br /> Consultancy for <br /> <span className="text-3xl md:text-6xl text-[#00c5ff]">Future Success</span> </h1>
                    </div>
                    {/* <!--Graph Section*/}
