...
function Footer() {
    return (
      <>
       {/* <section className="">
        <footer className="bg-[#1c1e39] text-center text-white mt-20">
              ...
              <div>
                <form action="">
                  <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                    ...
                    <div className="relative md:mb-6 text-black" data-te-input-wrapper-init>
                      <input
                        type="text"
                    ...
                    <div className="mb-6 md:mr-auto">
                      <button
                        type="submit"
                        className="inline-block rounded-full border-2 border-neutral-50 px-6 pt-2 pb-[6px]  font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:bg-white hover:text-black"
                        data-te-ripple-init
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="p-5 lg:mt-10">
                <img src={grachieverlogo} className="mt-0 sm:mt-0 md:-mt-10 lg:mt-[-120px] mb-3 w-16 mx-auto" />
              ...
              <div className="p-5 mt-0 sm:mt-0 md:mt-20 lg:mt-0">
                ...
                <div className="p-5 ">
                    ...
                    <p className="">Our Plane</p> 
                </div>
                <div className="p-5">
                    <p className="font-bold text-lg mb-5">Support</p>
            ...
            <div
              ...
              © 2023 Copyright:
              <a className="text-white" href="https://tailwind-elements.com/">Grachiever.com</a>
              </div>
              </footer>
          </section> */}
          ...
          <section className='bg-[#1c1e39] mt-10 pt-5'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 text-white mx-10">
              <div className="p-5">
                ...
                <p className='mt-3'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia nihil, nobis ratione in, molestias debitis reprehenderit, unde harum laborum.</p>
              </div>
                <div className="p-5">
                    <p className="font-bold text-lg mb-5">About</p>
