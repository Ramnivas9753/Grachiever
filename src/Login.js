function Login() {
  ...
  <form className="animate p-5 max-w-sm mx-auto bg-[#EBF5FB]" action="#" method="post">
    <div className="imgcontainer"> 
      ...
      <img src="images/LOGOS/sign_in.jpeg" alt="Grachiever Logo" className=" w-20 h-20 mx-auto rounded-full" />
    </div>
    <div className="w-full max-w-lg">
          ...
          <div className="row mt-3">
            <a href="#" className="fb btn btn_login w-full">
              <i className="fa fa-facebook fa-fw"></i> Login With Facebook
             </a>
            <a href="#" className="twitter btn btn_login">
              <i className="fa fa-twitter fa-fw"></i> Login With Twitter
            </a>
            <a href="#" className="google btn btn_login"><i className="fa fa-google fa-fw">
              </i> Login With Google+
            </a>
          </div>
